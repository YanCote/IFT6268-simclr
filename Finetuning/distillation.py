...
batch_size = yml_config['distillation']['batch']
...
total_steps = yml_config['distillation']['total_steps']
learning_rate = yml_config['distillation']['learning_rate']
momentum = yml_config['distillation']['momentum']
weight_decay = float(yml_config['distillation']['weight_decay'])
temperature = yml_config['distillation']['temperature']
...
hub_path = yml_config['distillation']['hub_path']
